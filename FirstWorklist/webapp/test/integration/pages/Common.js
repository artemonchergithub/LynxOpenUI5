sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/FirstWorklist/app", ".html");
		...
		return Opa5.extend("zjblessons.FirstWorklist.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/FirstWorklist/localService/mockserver"], function (mockserver) {
